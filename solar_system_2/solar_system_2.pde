/*
  ...
  //questi "slash" si chiamano commenti e ciò che viene
    ...
    Per chi fosse "curioso" ho inserito annotazioni in giro 
...
//una libreria scaricata per poter aggiungere le animazioni
...
//definisco i pianeti(il nome(classe))
Planet sun;
Planet mercurio;
Planet venere;
Planet terra;
...
void keyPressed() {
  //System.getProperty("user.name") serve per ottenere il nome dell'utente che sta usando il pc
